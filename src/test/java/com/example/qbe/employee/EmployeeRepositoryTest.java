...
class EmployeeRepositoryTest
{
	...
	void shouldFindAllSmithEmployees()
	{
		...
		smiths.forEach(smith -> assertEquals("Smith", smith.getLastName(),
	...
	void shouldFindAllJohnVariations()
	{
		...
		johns.forEach(john -> assertTrue(john.getFirstName().toLowerCase().contains("john"),
	...
	void shouldMatchUsingCustomMatcher()
	{
		...
		assertThat(matches)
				.isNotEmpty()
				.allMatch(employee -> employee.getFirstName().equalsIgnoreCase("JOHN") &&
